  ...
  return (
    <div className="space-y-12">
      ...
      <div className="space-y-4">
        <h1 className="text-4xl lg:text-5xl font-bold text-foreground tracking-tight">Veyro Documentation</h1>
      ...
      <div className="space-y-8">
        <h2 className="text-2xl font-bold text-foreground">Who these docs are for</h2>
        ...
        <ul className="space-y-4 list-disc pl-5 text-gray-500 font-medium text-sm">
          <li><span className="font-bold text-foreground">Property Managers & Landlords</span> — schedule showings and open houses, reduce time-to-rent.</li>
          <li><span className="font-bold text-foreground">Realtors & Leasing Teams</span> — delegate tours while staying focused on high-value work.</li>
          <li><span className="font-bold text-foreground">Showing Agents</span> — accept assignments, conduct tours, and submit summaries.</li>
        </ul>
      </div>

      <div className="space-y-8">
        <h2 className="text-2xl font-bold text-foreground">What's in these docs</h2>
      ...
      <div className="pt-12 border-t border-gray-50 flex justify-end">
        <a href="/docs/getting-started" className="group flex items-center gap-6 p-6 rounded-2xl border border-gray-100 hover:border-green-100 hover:bg-muted/50 transition-all">
