  ...
  return (
    <div className="min-h-screen bg-white font-sans text-foreground">
      ...
      <section className="bg-primary pt-36 pb-16 text-center px-6">
        <p className="text-[10px] font-black text-accent uppercase tracking-[0.2em] mb-4">How It Works</p>
        ...
        <p className="text-white/60 font-medium max-w-xl mx-auto text-base">
          ...
          <span className="text-accent font-bold">in minutes.</span>
        </p>
      </section>
      ...
      <section className="py-20 lg:py-28 bg-white px-6">
        <div className="max-w-4xl mx-auto">
          <p className="text-[10px] font-black text-accent uppercase tracking-[0.2em] mb-2">For Property Managers & Realtors</p>
          <h2 className="text-3xl lg:text-4xl font-bold text-foreground mb-14">Book a showing in minutes</h2>
          ...
          <div className="space-y-8">
            {[
              ...
              <div key={step.num} className="flex gap-6 items-start">
                <div className="w-10 h-10 rounded-full bg-primary text-white flex items-center justify-center font-bold text-sm flex-shrink-0 mt-0.5">
                  {step.num}
                </div>
          ...
          <div className="mt-12">
            <a
              href="/signup"
              className="inline-block bg-accent hover:bg-accent/90 text-white px-8 py-4 rounded-2xl font-bold transition-all hover:-translate-y-1 shadow-lg"
            >
      ...
      {/* For Agents */}
      <section className="py-20 lg:py-28 bg-background px-6">
        <div className="max-w-4xl mx-auto">
          <p className="text-[10px] font-black text-accent uppercase tracking-[0.2em] mb-2">For Showing Agents</p>
          <h2 className="text-3xl lg:text-4xl font-bold text-foreground mb-14">Earn on your schedule</h2>
          ...
          <div className="mt-12 text-center">
            <a
              href="/agent/apply"
              className="inline-flex items-center gap-2 bg-accent hover:bg-accent/90 text-white px-8 py-4 rounded-2xl font-bold transition-all hover:-translate-y-1 shadow-lg"
            >
              🪪 Join as Agent
            </a>
          </div>
      ...
      <section className="py-20 lg:py-28 bg-white px-6">
        <div className="max-w-5xl mx-auto">
          <p className="text-[10px] font-black text-accent uppercase tracking-[0.2em] mb-2 text-center">Why Veyro</p>
          <h2 className="text-3xl lg:text-4xl font-bold text-foreground mb-14 text-center">Built for busy real estate professionals</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div key={f.title} className="bg-background border border-gray-100 rounded-2xl p-6 space-y-3">
      ...
      <section className="bg-primary py-16 text-center px-6">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <a href="/signup" className="bg-accent hover:bg-accent/90 text-white px-8 py-4 rounded-2xl font-bold transition-all hover:-translate-y-1">
            Make a Booking
          </a>
