...
export default function SignupPage() {
  ...
  const handleSignup = async (formData: FormData) => {
    ...
    // Role is always USER on self-registration — only SUPERADMIN can elevate roles
    const role = 'USER';
      ...
      <div className="hidden lg:flex w-1/2 bg-primary p-24 flex-col justify-center relative overflow-hidden">
        ...
        <div className="relative z-10 space-y-12">
          ...
          <ul className="space-y-6">
            <FeatureItem text="Invite teammates and assign roles" />
            <FeatureItem text="Automated confirmations and reminders" />
            <FeatureItem text="Exportable activity logs and reports" />
            <FeatureItem text="No monthly fees — pay per showing" />
          </ul>
        </div>
      </div>
          ...
          <div className="bg-white rounded-[2.5rem] p-10 lg:p-12 shadow-sm border border-gray-50/50 space-y-10">
            ...
            <form action={handleSignup} className="space-y-5">
              <div className="space-y-1.5">
                <label className="text-xs font-bold text-gray-700 uppercase tracking-widest px-1">Full Name <span className="text-red-500">*</span></label>
                <input 
                  type="text" 
                  name="fullName"
              ...
              <div className="space-y-1.5">
                <label className="text-xs font-bold text-gray-700 uppercase tracking-widest px-1">Work Email <span className="text-red-500">*</span></label>
                <input 
                  type="email" 
                  name="email"
              ...
              <div className="space-y-1.5">
                <label className="text-xs font-bold text-gray-700 uppercase tracking-widest px-1">Password <span className="text-red-500">*</span></label>
                <input 
                  type="password" 
                  name="password"
